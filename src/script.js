...
const OPTIONS = {
    ...
    headers: {
      ...
      Authorization: YOUR_API_BEARER_KEY // Put your API Bearer key here
    }
  };
...
const SPECS = "&include_adult=false&language=en-US&page="+page_number;

const content_pane = document.getElementById("content-pane"); 
...
function getAPILINK_WithPageNumber(page_number){
  return APILINK
}
